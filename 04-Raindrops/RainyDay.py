...
class Hero:
    def __init__(self, screen, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        self.image_noumbrella = pygame.image.load(without_umbrella_filename)
        self.last_hit_time = 0

    def draw(self):
        """ Draws this sprite onto the screen. """
        # Done 17: Draw (blit) this Hero, at this Hero's position, WITHOUT an umbrella:
        self.screen.blit(self.image_noumbrella, (self.x, self.y))
        ...
        if time.time() > self.last_hit_time + 1:
            current_image = self.image_noumbrella
...
def main():
    ...
    while True:
        ...
        # Skip 22: Remove the code that reset the y of the test_drop when off_screen()
